function [sys,x0,str,ts,simStateCompliance] = DIARC_controller(t,x,u,flag)
...
switch flag
  ...
  %%%%%%%%%%%
  case 3
    sys=mdlOutputs(t,x,u,kf,p,k2,kappa,epsilon,dc_M,dM,Me_0,B_0,Asc_0,Acog1_0,Acog3_0,Me_max,B_max,Asc_max,Acog1_max,Acog3_max,Me_min,B_min,Asc_min,Acog1_min,Acog3_min) ;
...
function sys=mdlOutputs(t,x,u,kf,p,k2,kappa,epsilon,dc_M,dM,Me_0,B_0,Asc_0,Acog1_0,Acog3_0,Me_max,B_max,Asc_max,Acog1_max,Acog3_max,Me_min,B_min,Asc_min,Acog1_min,Acog3_min)
state_x1=u(1);
state_x2=u(2);
state_z2=u(3);
state_x2d_dot=u(4);
...
Phi_b_abs=abs(Phi_b);
h=dc_M+Phi_b_abs'*(theta_b_max-theta_b_min)+dM/Me_min;
