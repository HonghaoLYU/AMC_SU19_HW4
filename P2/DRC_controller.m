function [sys,x0,str,ts,simStateCompliance] = DRC_controller(t,x,u,flag)
...
theta_hat=[B_0;Asc_0;Acog1_0;Acog3_0]/Me_0;
b_hat=1/Me_0;
b_max=1/Me_min;
b_min=1/Me_max;
...
Phi_abs=abs(Phi_b);
h=Phi_abs'*(theta_b_max-theta_b_min)+dM/Me_min;
